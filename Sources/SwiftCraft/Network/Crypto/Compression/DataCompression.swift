...
extension Data {
    ...
    public func ungzip(skipCheckSumValidation: Bool = true) -> Data? {
        ...
        guard checkSums[0] == inflated.crc32(), checkSums[1] == UInt32(inflated.count) else {
            return nil
        }
        return inflated
    }
...
private func crc32Hash(_ data: UnsafeRawBufferPointer, crcInit: UInt32 = 0) -> UInt32 {
...
extension Data {
    ...
    fileprivate func crc32(crcInit: UInt32 = 0) -> UInt32 {
        return ContiguousArray(self).withUnsafeBytes { crc32Hash($0, crcInit: crcInit) }
    }
}
