...
public enum MinecraftEnglishTranslations {
    ...
    public static let patterns: [String: String] = [
        ...
        "advancements.adventure.sniper_duel.description": "Kill a skeleton with an arrow from more than 50 metres",
        ...
        "attribute.name.generic.armorToughness": "Armour Toughness",
        ...
        "commands.advancement.revoke.everything.failed": "Couldn't revoke any advancements from %1$s because they haven't started any",
        ...
        "commands.playsound.unknownSoundSource": "Sound Source %s is unknown",
        ...
        "item.banner.stripe_bottom.black": "Black Base",
        "item.banner.stripe_bottom.blue": "Blue Base",
        "item.banner.stripe_bottom.brown": "Brown Base",
        "item.banner.stripe_bottom.cyan": "Cyan Base",
        "item.banner.stripe_bottom.gray": "Grey Base",
        "item.banner.stripe_bottom.green": "Green Base",
        "item.banner.stripe_bottom.lightBlue": "Light Blue Base",
        "item.banner.stripe_bottom.lime": "Lime Base",
        "item.banner.stripe_bottom.magenta": "Magenta Base",
        "item.banner.stripe_bottom.orange": "Orange Base",
        "item.banner.stripe_bottom.pink": "Pink Base",
        "item.banner.stripe_bottom.purple": "Purple Base",
        "item.banner.stripe_bottom.red": "Red Base",
        "item.banner.stripe_bottom.silver": "Light Grey Base",
        "item.banner.stripe_bottom.white": "White Base",
        ...
        "item.banner.stripe_top.black": "Black Chief",
        "item.banner.stripe_top.blue": "Blue Chief",
        "item.banner.stripe_top.brown": "Brown Chief",
        "item.banner.stripe_top.cyan": "Cyan Chief",
        "item.banner.stripe_top.gray": "Grey Chief",
        "item.banner.stripe_top.green": "Green Chief",
        "item.banner.stripe_top.lightBlue": "Light Blue Chief",
        "item.banner.stripe_top.lime": "Lime Chief",
        "item.banner.stripe_top.magenta": "Magenta Chief",
        "item.banner.stripe_top.orange": "Orange Chief",
        "item.banner.stripe_top.pink": "Pink Chief",
        "item.banner.stripe_top.purple": "Purple Chief",
        "item.banner.stripe_top.red": "Red Chief",
        "item.banner.stripe_top.silver": "Light Grey Chief",
        ...
        "item.chickenCooked.name": "Roast Chicken",
        ...
        "item.fish.cod.cooked.name": "Cooked Cod",
        "item.fish.cod.raw.name": "Raw Cod",
        ...
        "item.goldNugget.name": "Golden Nugget",
        ...
        "item.mushroomStew.name": "Mushroom Soup",
        ...
        "item.potatoBaked.name": "Jacket Potato",
        ...
        "item.shield.gray.name": "Grey Shield",
        ...
        "item.shield.silver.name": "Light Grey Shield",
        ...
        "subtitles.entity.leashknot.break": "Lead knot breaks",
        "subtitles.entity.leashknot.place": "Lead knot tied",
        ...
        "tile.clayHardenedStained.gray.name": "Grey Terracotta",
        ...
        "tile.clayHardenedStained.silver.name": "Light Grey Terracotta",
        ...
        "tile.cloth.gray.name": "Grey Wool",
        ...
        "tile.cloth.silver.name": "Light Grey Wool",
        ...
        "tile.endPortalFrame.name": "End Portal Frame",
        ...
        "tile.ice.name": "Ice",
        "tile.icePacked.name": "Compressed Ice",
        ...
        "tile.woolCarpet.gray.name": "Grey Carpet",
        ...
        "tile.woolCarpet.silver.name": "Light Grey Carpet",
        ...
        "title.oldgl1": "Old graphics card found; this may prevent you from",
        "title.oldgl2": "playing in the far future as OpenGL 2.0 will be necessary.",
